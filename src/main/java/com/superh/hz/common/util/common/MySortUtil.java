...
/**
 * 功能说明：排序算法，对List<T> 成员属性： 成员方法： void bubbleSort(List<T> list)，冒泡排序 void
 * selectSort(List<T> list)，选择排序 void quickSort(List<T> list)，快速排序 void
 * heapSort(List<T> list),堆排序 2014-08-20
 * 
 * @update
 */
...
public class MySortUtil {
	 ...
	 * 快速排序,带边界下标
	 * 
	 * @param list List<T>, 待排序列表
	 * @param start int, 起始下标
	 * @param end int, 结束下标
	 * @param comparator Comparator<T>, 比较器
	 */
	...
	/**
	 * 堆排序：构建堆，让根节点成为最大节点 堆的核心思想是：先序遍历转化为二叉树
	 * 
	 * @param list
	 *            List<T>, 待排序列表
	 * @param father
